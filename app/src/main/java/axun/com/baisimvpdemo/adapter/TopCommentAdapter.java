...
public class TopCommentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<BaisiBean.ListBean.TopCommentsBean> mData;
    ...
    private BaisiBean.ListBean listBean;

    public TopCommentAdapter(Context context, List<BaisiBean.ListBean.TopCommentsBean> mData, BaisiBean.ListBean listBean){
